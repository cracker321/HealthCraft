...
export class Ingredient {
  ...
  // - 'fiber?: number'
  //   : - '? 기호' 가 붙은 '필드, 속성'은 그 속성이 속한 객체가 생성될 때 포함되지 않아도 TypeScript 는 오류를 발생시키지 않음.
  //     - 예를 들어, 어떤 사람의 정보(name 필드, age 필드, hobby 필드)를 담는 'Person 객체'를 만들 때, 
  //       'name 필드', 'age 필드'에 대한 정보는 필수적이지만,
