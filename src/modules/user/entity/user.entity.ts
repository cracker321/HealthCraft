...
export class User { // '클래스 User' 를 정의함.
  ...
  //         - '@OneToMany 데코레이터' 에서의 '첫 번째 인수, 함수'
  //           : 이 User 객체와 1:N 으로 연관관계를 맺을 대상 엔티티를 지정함.
  //             이 인수는 '화살표 함수'로 작성되며, 그 화살표 함수는 '연관관계를 맺을 대상 엔티티 클래스를 반환'한다!!
  //         - '@OneToMany 데코레이터' 에서의 '첫 번째 인수, 함수'
  //           : 이 User 객체와 1:N 으로 연관관계를 맺을 대상 엔티티의 내부 코드에서,
  //             그 '대상 엔티티 내부의 어떤 속성이 이 User 객체를 '참조'할지를 지정'하는 것임!
  //             즉, 그 대상 엔티티의 내부의 '속성 user'가, 'User 객체'를 '참조'하는 것을 명시해주는 것이다!!
  //             이 인수는 '화살표 함수'로 작성되며, 그 화살표 함수는 '대상 엔티티의 속성 user 를 반환'한다!!


  // - 첫 번째 인수, 함수: 'User 객체와 1:N 으로 연관관계를 맺을 연결될 대상 엔티티를 지정'.  
  //   () => HealthProfile
  ...
  // - 두 번째 인수, 함수: 'User 객체와 1:N 으로 연결될 엔티티의 참조 방향 지정'
